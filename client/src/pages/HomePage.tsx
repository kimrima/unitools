      ...
      <main className="flex-1">
        <section className="relative py-20 md:py-32 px-4 bg-white dark:bg-background overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            <h1 className="text-3xl sm:text-5xl md:text-7xl font-black text-slate-900 dark:text-foreground tracking-tight mb-4 md:mb-6 leading-tight" data-testid="text-hero-title">
              {t('Common.hero.titlePart1', { defaultValue: 'Free Tools to Make' })}{' '}
              <br className="hidden md:block" />
              <span className="relative inline-block">
                <span className="relative z-10 text-primary">{t('Common.hero.titlePart2', { defaultValue: 'Everything Simple' })}</span>
