...
export const allTools: Tool[] = [
  ...
  { 
    ...
    rating: 4.6,
    ratingCount: 1087,
    relatedTools: ['png-to-jpg', 'webp-to-png', 'convert-image'],
    acceptedFormats: ['image/jpeg', 'image/jpg'],
    outputFormats: ['png'],
  },
  { 
    ...
    rating: 4.5,
    ratingCount: 876,
    relatedTools: ['webp-to-png', 'jpg-to-webp', 'convert-image'],
  ...
  { 
    ...
    rating: 4.7,
    ratingCount: 1543,
    relatedTools: ['crop-image', 'compress-image', 'convert-image'],
